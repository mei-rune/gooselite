...
var TableAlreadyExistKeys = []string{"already exists", "已存在", "已经存在", "ORA-00955:", "同名关系(包括表、视图、索引、序列、同义词或包"}
...
var TableNotExistKeys = []string{"does not exist",  "doesn't exist", "不存在", "不存在或无权访问", "no such table"}
